 ...
 * - Auto-navigates on valid authentication
 *
 * Functions Inputs/Outputs:
 * - handleAuthentication: () => void
 *   Output: Authenticates user and handles navigation
 * - formIsValid: () => boolean
 *   Output: Returns form validation status
 * - isPasswordInvalid: () => boolean
 *   Output: Returns password validation status
 * - isEmailInvalid: () => boolean
 *   Output: Returns email validation status
 */
