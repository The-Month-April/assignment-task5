 ...
 * - navigation: Stack navigation prop for screen transitions
 * - mapViewRef: Reference to MapView component
 * - authenticationContext: User authentication context
 *
 * Component Capabilities:
 * - Displays interactive Google Map with event markers
 * - Shows user location and customized map styling
 * - Handles user logout functionality
 * - Enables navigation to event creation and details
 * - Auto-fits map to show all event markers
 *
 * Functions Inputs/Outputs:
 * - handleNavigateToCreateEvent: () => void
 *   Output: Navigates to event creation screen
 * - handleNavigateToEventDetails: () => void
 *   Output: Navigates to event details screen
 * - handleLogout: () => void
 *   Output: Clears user data and returns to login
 */
